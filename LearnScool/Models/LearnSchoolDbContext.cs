...
using LearnScool.Models.Enities;
using Microsoft.EntityFrameworkCore;

namespace LearnScool.Models;
...
public partial class LearnSchoolDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseSqlServer("Data Source=DESKTOP-GL157I4;Initial Catalog=LearnSchoolDb;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Service>(entity =>
        {
            ...
            entity.Property(e => e.ServiceCost).HasColumnType("decimal(19, 1)");
        });
